...
export default function JournalSelfCarePage() {
  ...
  return (
    <section className="mx-auto max-w-5xl px-3 text-text">
      ...
      <div className="mb-4 overflow-hidden rounded-xl border border-[var(--color-border)] bg-gradient-to-r from-sky-50 to-emerald-50 dark:from-sky-800/10 dark:to-emerald-800/10 p-4 sm:flex sm:items-center sm:justify-between">
